# Download all public domain GitHub repositories
This is a tool for downloading the ~9k GitHub repositories that are more than 25 stars and smaller than a gigabyte. 
Only repositories that have the "unlicense" or "cc0" license are included.
